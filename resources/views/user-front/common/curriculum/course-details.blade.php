                      ...
                      @if ($onlineGateway->keyword == 'stripe')
                        <div id="stripe-card-input" class="@if ($errors->has('card_number') || $errors->has('cvc_number') || $errors->has('expiry_month') || $errors->has('expiry_year')) d-block @else d-none @endif">
                          <div class="form-group mb-4">
                            <input type="text" class="form-control" name="card_number" placeholder="{{$keywords['enter_your_card_number'] ?? __('Enter Your Card Number') }}" autocomplete="off" oninput="checkCard(this.value)">
                          ...
                          <div class="form-group mb-4">
                            <input type="text" class="form-control" name="cvc_number" placeholder="{{ $keywords['enter_CVC_number'] ?? __('Enter CVC Number') }}" autocomplete="off" oninput="checkCVC(this.value)">
                          ...
                          <div class="form-group mb-4">
                            <input type="text" class="form-control" name="expiry_month" placeholder="{{$keywords['enter_expiry_month'] ??  __('Enter Expiry Month') }}">
                          ...
                          <div class="form-group mb-4">
                            <input type="text" class="form-control" name="expiry_year" placeholder="{{ $keywords['enter_expiry_year'] ?? __('Enter Expiry Year') }}">
