...
<html>
  <head>
    ...
    {{-- fav icon --}}
    <link rel="shortcut icon" type="image/png" href="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_FAVICON,$userBs->favicon,$userBs,'assets/front/img/'.$bs->favicon)}}">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="logo text-center">
              <img src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_LOGO,$userBs->logo,$userBs,'assets/front/img/'.$bs->logo)}}" alt="Company Logo">
            </div>
