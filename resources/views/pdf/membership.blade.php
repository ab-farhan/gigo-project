        ...
        <div class="header">
            ...
            <div class="order-details">
                <table class="text-right">
                    ...
                    <tr>
                        <td class="gry-color small"><strong>Package Price:</strong> {{$membership->package_price == 0 ? "Free": $membership->package_price}}</td>
                    </tr>
                    <tr>
                        <td class="gry-color small"><strong>Discount:</strong>  -<span class="text-success">{{$membership->discount}}</span></td>
                    </tr>
                    @endif
                    <tr>
                        <td class="gry-color small"><strong>Total:</strong> {{$amount}}</td>
                    </tr>
                    <tr>
