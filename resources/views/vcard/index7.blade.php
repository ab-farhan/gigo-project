    ...
    <div class="page-wrapper dark-page">
        <div class="container p-0">
            ...
            <div class="page-area page-area-three">
                <!--====== Start Admin  ======-->
                <div class="admin-box-three bg_cover lazy" data-bg="{{!empty($vcard->cover_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->cover_image,$userBs) : asset('assets/tenant/image/vcard/vcard_cover.jpg')}}">
                            ...
                            @foreach ($services as $service)
                                ...
                                @endif
                                    <div class="img-holder">
                                        <img data-src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_SERVICE_IMAGE,$service->image,$userBs)}}" alt="Image" class="lazy w-100">
                                ...
                                @foreach ($projects as $project)
                                    <div class="project-item">
                                        <div class="img-holder">
                                            ...
                                            <a href="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_PROJECT_IMAGE,$project->image,$userBs)}}" class="img-popup img-overlay"></a>
                                        </div>
                                        <div class="text text-center">
                                            <h3>{{$project->title}}</h3>
