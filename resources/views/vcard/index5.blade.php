...
<div class="page-wrapper red-light-bg">
    <div class="container p-0">
        ...
        <div class="page-area page-area-one">
            <!--====== Start Admin ======-->
            <div class="admin-box admin-box-one bg_cover lazy" data-bg="{{!empty($vcard->cover_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->cover_image,$userBs) : asset('assets/tenant/image/vcard/vcard_cover.jpg')}}">
