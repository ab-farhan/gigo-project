            ...
            <div class="page-content page-content-three">
                ...
                <div class="admin-wrapper">
                    <div class="admin-card text-center">
                        <div class="thumb">
                            <img src="{{!empty($vcard->profile_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->profile_image,$userBs) : asset('assets/front/img/user/blank_propic.png')}}" alt="Picture">
                        </div>
                        <div class="content">
