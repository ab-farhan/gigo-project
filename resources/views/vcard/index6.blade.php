...
@if ($vcard->direction == 2)
@section('rtl-css')
<link rel="stylesheet" href="{{asset('assets/front/user/css/vcard/template5-10/rtl-style.css')}}">
@endsection
@endif

@section('base-color')
<link rel="stylesheet" href="{{asset('assets/front/user/css/vcard/template5-10/vcard-base-color.php').'?color='.$vcard->base_color}}">
@endsection

@section('og-image', !empty($vcard->cover_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->cover_image,$userBs) : asset('assets/tenant/image/vcard/vcard_cover.jpg'))
@section('og-title')
...
<style>
    .admin-box-two:before {
        background: url({{!empty($vcard->cover_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->cover_image,$userBs) : asset('assets/tenant/image/vcard/vcard_cover.jpg')}});
    }
</style>
@endsection
                ...
                <div class="admin-box-two">
                    <div class="admin-info-box text-center" style="background-color: #{{$vcard->summary_background_color}};">
                        <div class="user-thumb">
                            <img class="lazy" data-src="{{!empty($vcard->profile_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->profile_image,$userBs) : asset('assets/front/img/user/blank_propic.png')}}" alt="user thumb">
                        </div>
                        <div class="user-info">
                        ...
                        <div class="service-slider-one">
                            ...
                            @foreach ($services as $service)
                                <div class="service-item">
                                    ...
                                    @endif
                                        <img class="lazy" data-src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_SERVICE_IMAGE,$service->image,$userBs)}}" alt="service img" src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_SERVICE_IMAGE,$service->image,$userBs)}}" alt="Image">
                            ...
                            @foreach ($projects as $project)
                                <div class="project-item">
                                    <div class="img-holder">
                                        <img data-src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_PROJECT_IMAGE,$project->image,$userBs)}}" class="lazy" alt="">
                                        <a class="img-overlay img-popup" href="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_PROJECT_IMAGE,$project->image,$userBs)}}"></a>
                                    </div>
                                    <div class="text">
                                    ...
                                    <div class="testimonial-content text-center">
                                        <div class="author-title-thumb">
                                            <div class="author-thumb">
                                                <img data-src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_TESTIMONIAL_IMAGE,$testimonial->image,$userBs)}}" class="lazy" alt="">
                                            </div>
