...
@if ($vcard->direction == 2)
@section('rtl-css')
<link rel="stylesheet" href="{{asset('assets/tenant/css/vcard/vcard-rtl.css')}}">
@endsection
@endif

@section('base-color')
<link rel="stylesheet" href="{{asset('assets/tenant/css/vcard/vcard-base-color.php').'?color='.$vcard->base_color}}">
@endsection

@section('og-image', \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->cover_image,$userBs))
@section('og-title')
        ...
        <div class="page-wrapper">
            <div class="container p-0">
                <div class="page-content page-content-four">
                    <div class="page-banner bg_cover" style="background-image: url({{!empty($vcard->cover_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->cover_image,$userBs) : asset('assets/tenant/image/vcard/vcard_cover.jpg')}});"></div>
                    <div class="admin-wrapper">
                        <div class="admin-card text-center">
                            <div class="thumb">
                                <img src="{{!empty($vcard->profile_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->profile_image,$userBs) : asset('assets/front/img/user/blank_propic.png')}}" alt="Thumb">
                            </div>
                            <div class="content">
                                ...
                                <div class="actions">
                                    ...
                                    <div class="action-btn">
                                        <a href="//wa.me/{{$vcard->phone}}?text=Hello" class="whatsapp" style="background: #{{$vcard->whatsapp_button_color}}"><i class="fab fa-whatsapp"></i></a>
                                        <br>
                    ...
                    <div class="page-info-widget">
                        ...
                        <div class="info-widget d-flex align-items-center">
                            <a href="//www.google.com/maps?q={{$vcard->address}}" class="icon icon-1" style="background: #{{$vcard->address_icon_color}}1a;">
                                <i class="fas fa-map-marker-alt" style="color: #{{$vcard->address_icon_color}};"></i>
                            </a>
                            <div class="content">
                                <span class="title">{{$keywords["Address"] ?? "Address"}}</span>
                                <h5><a href="//www.google.com/maps?q={{$vcard->address}}">{{$vcard->address}}</a></h5>
                            </div>
                        </div>
                        @endif
                        ...
                        @foreach ($infos as $info)
                            <div class="info-widget d-flex align-items-center">
                                @if (!empty($info['link']) && $info['link'] == 1)
                                ...
                                <div class="content">
                                    ...
                                    <h5><a @if (!empty($info['link']) && $info['link'] == 1) target="_blank" href="{{$info['value']}}" @endif>{{$info['value']}}</a></h5>
                                </div>
                            </div>
                        @endforeach
                    </div>
                        ...
                        @foreach ($services as $service)
                            <div class="service-item mb-3">
                                <div class="service-img">
                                    <img class="w-100 lazy" data-src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_SERVICE_IMAGE,$service->image,$userBs)}}" alt="service img" src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_SERVICE_IMAGE,$service->image,$userBs)}}">
                                </div>
                                <div class="content">
                                    <h4>{{$service->title}}</h4>
                        ...
                        <div class="portfolio-slider-one">
                            ...
                            <div class="portfolio-item">
                                <div class="portfolio-img">
                                    <img data-src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_PROJECT_IMAGE,$project->image,$userBs)}}" alt="portfolio" class="w-100 lazy">
                                    <a href="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_PROJECT_IMAGE,$project->image,$userBs)}}" class="portfolio-overlay img-popup">
                                        <div class="info">
                    ...
                    <div class="video-section-widget video-section-four">
                        <div class="row">
                            <div class="col-12">
                                <div class="section-title">
                    ...
                    <div class="testimonial-section-widget testimonial-section-four">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <div class="section-title">
                        ...
                        @php
                            $testimonials = !empty($vcard->user_vcard_testimonials) ? $vcard->user_vcard_testimonials : [];
                        @endphp
                        ...
                        <div class="testimonial-slider-one">
                            ...
                            <div class="testimonial-item">
                                <div class="title-thumb d-flex align-items-center">
                                    <div class="thumb">
                                        <img class="lazy" data-src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_TESTIMONIAL_IMAGE,$testimonial->image,$userBs)}}" alt="thumb" src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_TESTIMONIAL_IMAGE,$testimonial->image,$userBs)}}">
                                    </div>
                                    <div class="title">
                    ...
                    <div class="contact-section-widget contact-section-four">
                        <div class="row">
                            <div class="col-12">
                                <div class="section-title">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form_group">
                                            <input type="text" class="form_control" placeholder="Enter Full Name" name="fullname" required>
                                    ...
                                    <div class="col-12">
                                        <div class="form_group">
                                            <textarea class="form_control" placeholder="Enter message" name="message"></textarea>
