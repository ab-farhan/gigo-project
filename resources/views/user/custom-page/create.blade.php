        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="pageForm" action="{{ route('user.custom_pages.store_page') }}" method="POST">
                @csrf
                <div class="row">
                  <div class="col-lg-12">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->rtl == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea class="form-control summernote" name="{{ $language->code }}_content" placeholder="Enter Content" data-height="300"></textarea>
                              </div>
                            </div>
                          </div>
