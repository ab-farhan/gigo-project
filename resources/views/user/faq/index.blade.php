        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{ route('user.faq_management.bulk_delete_faq') }}">
                      ...
                      @foreach ($faqs as $faq)
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteform d-inline-block" action="{{ route('user.faq_management.delete_faq', ['id' => $faq->id]) }}" method="post">
                              @csrf
