...
@section('content')
    <div class="mt-2 mb-4">
        <h2 class="pb-2">{{__('Welcome back')}}, {{Auth::guard('web')->user()->first_name}} {{Auth::guard('web')->user()->last_name}}!</h2>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4">
            <a class="card card-stats card-round" href="{{route('user.home_page.testimonials_section',['language' => $default->code])}}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5">
                        ...
                        <div class="col-7 col-stats">
                            <div class="numbers">
                                <p class="card-category">{{__('Testimonials')}}</p>
        ...
        <div class="col-sm-6 col-md-4">
            <a class="card card-stats card-warning card-round" href="{{ route('user.course_management.courses', ['language' => $default->code]) }}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5">
                            <div class="icon-big text-center">
        ...
        <div class="col-sm-6 col-md-4">
            <a class="card card-stats card-info card-round" href="{{ route('user.instructors', ['language' => $default->code]) }}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5">
                            <div class="icon-big text-center">
        ...
        <div class="col-sm-6 col-md-4">
            <a class="card card-stats card-primary card-round" href="{{ route('user.blog_management.categories', ['language' => $default->code]) }}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5">
                            <div class="icon-big text-center">
                        ...
                        <div class="col-7 col-stats">
                            <div class="numbers">
                                <p class="card-category">{{__('Blog Categories')}}</p>
                                <h4 class="card-title">{{$blog_categories}}</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-md-4">
            <a class="card card-stats card-success card-round" href="{{ route('user.blog_management.blogs', ['language' => $default->code]) }}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5">
                            <div class="icon-big text-center">
        ...
        <div class="col-sm-6 col-md-4">
            <a class="card card-stats card-secondary card-round" href="{{ route('user.advertisements') }}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5">
                            <div class="icon-big text-center">
                        ...
                        <div class="col-7 col-stats">
                            <div class="numbers">
                                <p class="card-category">{{__('Advertisement')}}</p>
        ...
        @if (!empty($permissions) && in_array('Coupon', $permissions))
            <div class="col-sm-6 col-md-4">
                <a class="card card-stats card-secondary card-round" href="{{ route('user.course_management.coupons') }}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-5">
                                <div class="icon-big text-center">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    <p class="card-category">{{__('Coupon')}}</p>
            ...
            <a class="card card-stats card-primary card-round" href="{{route('user.following.list')}}">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-7 col-stats">
                            <div class="numbers">
                                <p class="card-category">{{__('Followings')}}</p>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p><strong
                                                                    >{{__('Cost')}}: </strong> {{$membership->price == 0 ? "Free" : $membership->price}}
                                                                </p>
                                                                <p><strong
                                                                    >{{__('Currency')}}: </strong> {{$membership->currency}}
                                                                </p>
                                                                <p><strong
                                                                    >{{__('Method')}}: </strong> {{$membership->payment_method}}
                                                                </p>
                                                                <h3 class="text-warning">{{__('Package Details')}}</h3>
                                                                <p><strong
                                                                    >{{__('Title')}}: </strong>{{!empty($membership->package) ? $membership->package->title : ''}}
                                                                </p>
                                                                <p><strong
                                                                    >{{__('Term')}}: </strong> {{!empty($membership->package) ? $membership->package->term : ''}}
                                                                </p>
                                                                <p><strong >{{__('Start Date')}}: </strong>{{\Illuminate\Support\Carbon::parse($membership->start_date)->format('M-d-Y')}}
                                                                </p>
                                                                <p><strong >{{__('Expire Date')}}: </strong>{{\Illuminate\Support\Carbon::parse($membership->expire_date)->format('M-d-Y')}}
                                                                </p>
                                                                <p>
