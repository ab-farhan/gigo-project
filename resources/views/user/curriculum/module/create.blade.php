  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Module') }}</h5>
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="{{ route('user.course_management.course.store_module', ['id' => $course->id]) }}" method="post">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control ltr" name="serial_number" placeholder="Enter Module Serial Number">
