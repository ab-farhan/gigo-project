  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('user.course_management.lesson.update_text') }}" method="POST" id="editTextForm">
          
          @csrf
          <input type="hidden" id="inid" name="id">

          <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
            <textarea name="text" class="form-control summernote" placeholder="Enter Text" data-height="300" id="intext"></textarea>
