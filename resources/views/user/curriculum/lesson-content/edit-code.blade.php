  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('user.course_management.lesson.update_code') }}" method="POST" id="editCodeForm">
          
          @csrf
          <input type="hidden" id="incontent_id" name="id">

          <div class="form-group">
            <textarea name="code" class="form-control" placeholder="Enter Code" rows="15" id="incode"></textarea>
