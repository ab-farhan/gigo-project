...
@section('content')
        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 mt-2 mt-lg-0">
              <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-primary btn-sm float-lg-right float-left"><i class="fas fa-plus"></i> {{ __('Add Coupon') }}</a>
            </div>
          </div>
        </div>
                      ...
                      @foreach ($coupons as $coupon)
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteform d-inline-block" action="{{ route('user.course_management.delete_coupon', ['id' => $coupon->id]) }}" method="post">
  ...
  {{-- create modal --}}
  @include('user.curriculum.coupon.create')

  {{-- edit modal --}}
  @include('user.curriculum.coupon.edit')
@endsection
