        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="thanksPageForm" action="{{ route('user.course_management.course.update_thanks_page', ['id' => $course->id]) }}" method="POST">
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group {{ $language->rtl == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea class="form-control summernote" name="{{ $language->code }}_thanks_page_content" placeholder="Enter Page Content" data-height="300">{{ !isset($courseData->thanks_page_content) ? '' : replaceBaseUrl($courseData->thanks_page_content) }}</textarea>
                              </div>
                            </div>
                          </div>
                        </div>
