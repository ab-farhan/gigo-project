                            ...
                            <form id="courseForm"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <img
                                                    src="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_COURSE_THUMBNAIL_IMAGE,$course->thumbnail_image,$userBs)}}"
                                                    alt="..."
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <img
                                                    src="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_COURSE_COVER_IMAGE,$course->cover_image,$userBs) }}"
                                                    alt="..."
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="pricing_type" value="free"
                                                   class="selectgroup-input" {{ $course->pricing_type == 'free' ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Free') }}</span>
                                        </label>

                                        <label class="selectgroup-item">
                                            <input type="radio" name="pricing_type" value="premium"
                                                   class="selectgroup-input" {{ $course->pricing_type == 'premium' ? 'checked' : '' }}>
                                ...
                                <div id="accordion" class="mt-3">
                                    @foreach ($languages as $language)
                                        @php
                                            $courseData = $language->courseInformation()->where('user_id', Auth::guard('web')->user()->id)->where('course_id', $course->id)->first();
                                        @endphp
                                                            ...
                                                            <div
                                                                ...
                                                                <select name="{{ $language->code }}_category_id"
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        @foreach ($categories as $category)
                                                                            <option
                                                                                value="{{ $category->id }}" {{ $courseData->course_category_id == $category->id ? 'selected' : '' }}>
                                                                                {{ $category->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                            ...
                                                            <div
                                                                ...
                                                                <select name="{{ $language->code }}_instructor_id"
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        @foreach ($instructors as $instructor)
                                                                            <option
                                                                                value="{{ $instructor->id }}" {{ $courseData->instructor_id == $instructor->id ? 'selected' : '' }}>
                                                                                {{ $instructor->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                        ...
                                                        <div class="col">
                                                            <div
                                                                ...
                                                                <textarea class="form-control summernote"
                                                                          ...
                                                                          data-height="300">{{ is_null($courseData) ? '' : replaceBaseUrl($courseData->description, 'summernote') }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
