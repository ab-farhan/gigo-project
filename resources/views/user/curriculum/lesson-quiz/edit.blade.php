        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="ajaxEditForm" action="{{ route('user.course_management.lesson.update_quiz', ['id' => $quiz->id]) }}" method="POST">
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input class="form-control {{$courseInfo->language->rtl == 1 ? 'rtl' : ''}}" type="text" name="question" placeholder="Enter Question" value="{{ $quiz->question }}">
                  ...
                  <div class="row" v-for="(answer, index) in answers" v-bind:key="answer.uniqId">
                    ...
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control {{$courseInfo->language->rtl == 1 ? 'rtl' : ''}}" name="options[]" placeholder="Enter Option" v-model="answer.option">
                      </div>
                    </div>
...
@section('scripts')
  ...
  <script src="{{ asset('assets/tenant/js/quiz/edit.js') }}"></script>
@endsection
