        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 mt-2 mt-lg-0">
              <a class="btn btn-info btn-sm float-right" href="{{ route('user.course_management.lesson.contents', ['id' => $lesson->id, 'course' => request()->input('course'), 'language' => $defaultLang->code]) }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="ajaxForm" action="{{ route('user.course_management.lesson.store_quiz', ['id' => $lesson->id]) }}" method="POST">
                @csrf
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      <label>{{ __('Question') . '*' }}</label>
                      <input class="form-control {{$courseInfo->language->rtl == 1 ? 'rtl' : ''}}" type="text" name="question" placeholder="Enter Question">
                  ...
                  <div class="row" v-for="(answer, index) in answers" v-bind:key="answer.uniqId">
                    ...
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control {{$courseInfo->language->rtl == 1 ? 'rtl' : ''}}" name="options[]" placeholder="Enter Option">
                      </div>
                    </div>
...
@section('scripts')
  ...
  <script src="{{ asset('assets/tenant/js/quiz/create.js') }}"></script>
@endsection
