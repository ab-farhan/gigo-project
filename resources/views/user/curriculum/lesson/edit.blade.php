  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Lesson') }}</h5>
      ...
      <div class="modal-body">
        <form id="lessonEditForm" class="modal-form" action="{{ route('user.course_management.module.update_lesson') }}" method="post">
          ...
          <div class="form-group">
            ...
            <select name="status" class="form-control" id="lesson_status">
              <option disabled>{{ __('Select Lesson Status') }}</option>
