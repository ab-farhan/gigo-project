                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 showBackgroundImage mb-3">
                                                <img
                                                    src="{{isset($data->background_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_ACTION_SECTION_IMAGE,$data->background_image,$userBs) : asset('assets/tenant/image/default.jpg')}}"
                                                    alt="..."
                                                    class="img-thumbnail">
                                            </div>
                                            ...
                                            <p class="text-warning mb-0">Upload 1920 X 540 image for best quality</p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 showImage mb-3">
                                                    @if (!empty($data))
                                                        <img src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_ACTION_SECTION_IMAGE,$data->image,$userBs)}}" alt="..." class="img-thumbnail">
                                                    @else
                                                        <img src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_ACTION_SECTION_IMAGE,null,$userBs)}}" alt="..." class="img-thumbnail">
                                                    @endif
                                                </div>
