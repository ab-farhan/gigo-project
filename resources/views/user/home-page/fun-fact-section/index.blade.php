                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 showBackgroundImage mb-3">
                                                    <img
                                                        src="{{isset($data->background_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_FUN_FACT_SECTION_IMAGE,$data->background_image,$userBs) : asset('assets/tenant/image/default.jpg')}}"
                                                        alt="..."
                                                        class="img-thumbnail">
                                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary btn-sm mr-1 editbtn" href="#"
                                                       ...
                                                       data-id="{{ $countInfo->id }}" data-icon="{{ $countInfo->icon }}"
