...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form id="ajaxForm" action="{{ route('user.instructor.store_social_link', ['id' => $instructor->id]) }}" method="post">
          @csrf
          <div class="card-header">
            <div class="card-title d-inline-block">
              {{ __('Add Social Link') }}
            </div>
            <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('user.instructors', ['language' => $defaultLang->code]) }}">
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="url" placeholder="Enter URL of Social Media Account">
                    ...
                    <tbody>
                      @foreach ($socialLinks as $socialLink)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1" href="{{ route('user.instructor.edit_social_link', ['instructor_id' => $socialLink->instructor_id, 'id' => $socialLink->id]) }}">
                              <span class="btn-label">
                            ...
                            <form class="d-inline-block deleteform" action="{{ route('user.instructor.delete_social_link', ['id' => $socialLink->id]) }}" method="post">
