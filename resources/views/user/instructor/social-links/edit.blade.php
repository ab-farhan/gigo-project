...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form id="ajaxEditForm" action="{{ route('user.instructor.update_social_link', ['id' => $socialLink->id]) }}" method="post">
          ...
          <div class="card-header">
            ...
            <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('user.instructor.social_links', ['id' => $instructor->id]) }}">
              ...
              <div class="col-lg-6 offset-lg-3">
                  <div class="form-group">
                      ...
                      <div class="btn-group d-block">
                          <button type="button" class="btn btn-primary iconpicker-component"><i class="{{$socialLink->icon}}"></i></button>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="url" value="{{ $socialLink->url }}" placeholder="Enter URL of Social Media Account">
                  <p class="mt-2 mb-0 text-danger" id="editErr_url"></p>
                </div>

                <div class="form-group">
                  <label for="">{{ __('Serial Number') . '*' }}</label>
                  <input type="number" class="form-control" name="serial_number" value="{{ $socialLink->serial_number }}" placeholder="Enter Serial Number">
