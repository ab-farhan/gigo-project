    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('user.blog_management.blogs', ['language' => $defaultLang->code]) }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="blogForm" action="{{ route('user.blog_management.store_blog') }}" method="POST" enctype="multipart/form-data">
                @csrf
                  <div class="row">
                      <div class="col-lg-12">
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group {{ $language->rtl == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <input type="text" class="form-control" name="{{ $language->code }}_author" placeholder="Enter Author Name">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group {{ $language->rtl == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea class="form-control summernote" name="{{ $language->code }}_content" placeholder="Enter Blog Content" data-height="300"></textarea>
                              </div>
                            </div>
                          </div>
