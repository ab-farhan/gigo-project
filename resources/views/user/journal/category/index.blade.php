...
@section('content')
        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete" data-href="{{ route('user.blog_management.bulk_delete_category') }}">
                      ...
                      @foreach ($categories as $category)
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteform d-inline-block" action="{{ route('user.blog_management.delete_category', ['id' => $category->id]) }}" method="post">
  ...
  {{-- create modal --}}
  @include('user.journal.category.create')

  {{-- edit modal --}}
  @include('user.journal.category.edit')
@endsection
