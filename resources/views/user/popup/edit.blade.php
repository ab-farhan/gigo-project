            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                       href="{{ route('user.announcement_popups', ['language' => $defaultLang->code]) }}">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 showImage mb-3">
                                                <img
                                                    src="{{isset($popup->image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_ANNOUNCEMENT_POPUP_IMAGE,$popup->image,$userBs) : asset('assets/tenant/image/default.jpg')}}"
                                                    alt="..."
                                                    class="img-thumbnail">
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                   placeholder="Enter Popup Name" value="{{ $popup->name }}">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="title"
                                                       placeholder="Enter Popup Title" value="{{ $popup->title }}">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control ltr" name="delay"
                                                   placeholder="Enter Popup Delay" value="{{ $popup->delay }}">
