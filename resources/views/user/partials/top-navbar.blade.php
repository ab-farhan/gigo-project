<div class="main-header">
    ...
    <div class="logo-header" @if(request()->cookie('user-theme') == 'dark') data-background-color="dark2" @endif>
        <a href="{{route('front.user.detail.view', Auth::guard('web')->user()->username)}}" class="logo" target="_blank">
        <img src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_LOGO,$userBs->logo,$userBs,'assets/admin/img/propics/blank_user.jpg')}}" alt="navbar brand" class="navbar-brand">
        </a>
