                                    ...
                                    <table class="table table-striped mt-3" id="basic-datatables">
                                        ...
                                        @foreach ($qrcodes as $key => $qrcode)
                                            <tr>
                                                ...
                                                <td>
                                                    <form class="d-inline-block" action="{{ route('user.qrcode.download', ['name' => $qrcode->image]) }}" method="GET">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            <div class="p-5 bg-white">
                                                                <img src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_QRCODE_IMAGE,$qrcode->image,$userBs)}}" alt="">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer justify-content-center">
                                                            <form action="{{ route('user.qrcode.download', ['name' => $qrcode->image]) }}" method="GET">
                                                                <button type="submit" class="btn btn-sm btn-secondary">
