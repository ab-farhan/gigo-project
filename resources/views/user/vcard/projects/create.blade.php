          ...
          <div class="modal-body">
             ...
             <form id="ajaxForm" enctype="multipart/form-data" class="modal-form" action="{{route('user.vcard.projectStore')}}" method="POST">
                ...
                <div class="form-group">
                   ...
                   <input type="text" class="form-control {{$vcard->direction == 2 ? 'rtl' : ''}}" name="title" value="">
                ...
                <div id="app">
                 ...
                 <div class="form-group dis-none" id="extLink">
                  ...
                  <div class="form-group" id="shortDetails">
                     ...
                     <textarea class="form-control {{$vcard->direction == 2 ? 'rtl' : ''}}" name="short_details" rows="4" cols="80"></textarea>
                     <p class="text-warning mb-0">{{__('If you dont want any details content, then leave this field blank')}}</p>
