    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
       <div class="modal-content">
          <div class="modal-header">
             <h5 class="modal-title" id="exampleModalLongTitle">{{__('Add vCard Project')}}</h5>
          ...
          <div class="modal-body">
             ...
             <form id="ajaxEditForm" enctype="multipart/form-data" class="modal-form" action="{{route('user.vcard.projectUpdate')}}" method="POST">
                ...
                <div class="form-group">
                   ...
                   <input id="intitle" type="text" class="form-control {{$vcard->direction == 2 ? 'rtl' : ''}}" name="title" value="">
                ...
                <div id="editApp">
                 ...
                 <div class="form-group dis-none" id="eextLink">
                    ...
                    <p class="text-warning mb-0">{{__('If you dont want any details content, then leave this field blank')}}</p>
                  ...
                  <div class="form-group dis-none" id="eshortDetails">
                     ...
                     <textarea id="inshort_details" class="form-control {{$vcard->direction == 2 ? 'rtl' : ''}}" name="short_details" rows="4" cols="80"></textarea>
                     <p class="text-warning mb-0">{{__('If you dont want any details content, then leave this field blank')}}</p>
                ...
                <div class="form-group">
                   ...
                   <p class="text-warning mb-0"><small>{{__('The higher the serial number is, the later the project will be shown.')}}</small></p>
                </div>
             </form>
          </div>
