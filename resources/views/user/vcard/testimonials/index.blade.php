                            ...
                            <table class="table table-striped mt-3" id="basic-datatables">
                                ...
                                @foreach ($testimonials as $key => $testimonial)
                                    <tr>
                                        ...
                                        <td><img src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_TESTIMONIAL_IMAGE,$testimonial->image,$userBs)}}" alt="" width="80"></td>
