         ...
         <div class="card-body pt-5 pb-5">
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <form id="ajaxForm" action="{{route('user.vcard.update')}}" method="POST" enctype="multipart/form-data">
                     @csrf
                                 ...
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/1.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/2.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/3.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/4.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/5.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/6.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/7.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/8.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/9.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                                 <div class="col-2">
                                    <label class="imagecheck mb-4">
                                       ...
                                       <figure class="imagecheck-figure">
                                          <img src="{{asset('assets/tenant/image/vcard-templates/10.jpg')}}" alt="title" class="imagecheck-image">
                                       </figure>
                                    </label>
                                 </div>
                              </div>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-12 showImage mb-3">
                              <img src="{{!empty($vcard->profile_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->profile_image,$userBs) : asset('assets/tenant/image/default.jpg')}}" alt="..." class="img-thumbnail">
                            </div>
                            ...
                            <p class="text-warning mb-0">
                               {{__('Image size can be maximum 2.5MB')}}
                            </p>
                            <p class="text-warning mb-0">{{__('Upload 85 X 85 image for best quality')}}</p>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-12 showImage mb-3">
                              <img src="{{!empty($vcard->cover_image) ? \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VCARD_IMAGE,$vcard->cover_image,$userBs) : asset('assets/admin/img/noimage.jpg')}}" alt="..." class="img-thumbnail">
                            </div>
                            <input type="file" name="cover_image" class="form-control image">
                            <p id="errcover_image" class="mb-0 text-danger em"></p>
                            <p class="text-warning mb-0">{{__('Upload 415 X 260 image for best quality')}}</p>
                          </div>
                        </div>
                      </div>
...
@section('scripts')
   <script>
    ...
    <script src="{{asset('assets/tenant/js/vcard/edit-vcard.js')}}"></script>
@endsection
