                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <form id="ajaxForm" action="{{ route('user.update_maintenance_mode') }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="col-12 mb-2">
                                                <label
                                                    for="image"><strong>{{ __('Maintenance Mode Image') . '*' }}</strong></label>
                                            </div>
                                            <div class="col-md-12 showImage mb-3">
                                                <img src="{{\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_MAINTENANCE_IMAGE,$data->maintenance_img,$userBs)}}"
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="maintenance_status" value="1"
                                                   class="selectgroup-input" {{ $data->maintenance_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="maintenance_status" value="0"
                                                   class="selectgroup-input" {{ $data->maintenance_status == 0 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="maintenance_msg" rows="3"
                                              cols="80">{!! $data->maintenance_msg !!}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="mt-2 mb-0 text-info">
                                        ...
                                        <span class="text-warning">{{url('/').'/'.\Illuminate\Support\Facades\Auth::user()->username.'/apply/your-bypass-token-here'}}</span><br>
