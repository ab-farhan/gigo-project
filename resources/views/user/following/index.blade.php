...
<div class="page-header">
   <h4 class="page-title">{{__('Following List')}}</h4>
   <ul class="breadcrumbs">
      ...
      <li class="nav-item">
         <a href="#">{{__('Following Page')}}</a>
      </li>
      <li class="separator">
         <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
         <a href="#">{{__('Following')}}</a>
      </li>
   </ul>
</div>
<div class="row">
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="row">
               <div class="col-lg-4">
                  <div class="card-title d-inline-block">{{__('Following')}}</div>
               </div>
               <div class="col-lg-3">
               </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                 @if(is_null($userDefaultLang))
                   ...
                   @else
                       @if (count($users) == 0)
                           <h3 class="text-center">{{__('NO FOLLOWING USER FOUND')}}</h3>
                       @else
