                            ...
                            <div class="btn-groups">
                                <a href="error.html" class="btn btn-img radius-sm size-sm" title="App Store"
                                    ...
                                    <img class="blur-up ls-is-cached lazyloaded"
                                        src="{{ asset('/') }}assets/front/images/app-store.png"
                                ...
                                <a href="error.html" class="btn btn-img radius-sm size-sm" title="Play Store"
                                    target="_blank">
                                    <img class="blur-up ls-is-cached lazyloaded"
                                        src="{{ asset('/') }}assets/front/images/play-store.png"
                                        data-src="{{ asset('/') }}assets/front/images/play-store.png"
                                        alt="App Store">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-6">
                        <div class="footer-widget" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <div class="newsletter-form">
                                <form id="newsletterForm" action="{{ route('front.subscribe') }}" method="POST"
                                    class="subscribeForm">
                                    @csrf
                                    <div class="form-group">
                                        <input class="form-control radius-sm" name="email"
                                            placeholder="{{ __('Enter email here...') }}" type="text" name="EMAIL"
