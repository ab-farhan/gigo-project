                ...
                <div class="card-body pt-5 pb-5">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="home_section" value="1" class="selectgroup-input" {{$abs->home_section == 1 ? 'checked' : ''}}>
                                        <span class="selectgroup-button">{{__('Active')}}</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="home_section" value="0" class="selectgroup-input" {{$abs->home_section == 0 ? 'checked' : ''}}>
                            ...
                            <div class="form-group">
                                <label>{{__('Template Section')}} **</label>
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="template_section" value="1" class="selectgroup-input" {{$abs->template_section == 1 ? 'checked' : ''}}>
                                        <span class="selectgroup-button">{{__('Active')}}</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="template_section" value="0" class="selectgroup-input" {{$abs->template_section == 0 ? 'checked' : ''}}>
                                        <span class="selectgroup-button">{{__('Deactive')}}</span>
                                    </label>
                                </div>
                            </div>
