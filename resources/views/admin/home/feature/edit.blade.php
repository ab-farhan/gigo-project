            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="showImage mb-3">
                                    <img src="{{ !empty($feature->icon) ? asset('assets/front/img/feature/'.$feature->icon) : asset('assets/admin/img/noimage.jpg')}}" alt="..." class="img-thumbnail">
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="title" placeholder="{{__('Enter title')}}" value="{{$feature->title}}">
                        @if ($errors->has('title'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="text" placeholder="{{__('Enter text')}}" value="{{$feature->text}}">
                        @if ($errors->has('text'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="serial_number" value="{{$feature->serial_number}}" placeholder="{{__('Enter Serial Number')}}">
