                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input name="preview_templates_title" class="form-control" value="{{$abs->preview_templates_title}}">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input name="preview_templates_subtitle" class="form-control" value="{{$abs->preview_templates_subtitle}}">
