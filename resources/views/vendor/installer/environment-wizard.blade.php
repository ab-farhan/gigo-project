...
@section('container')
    <div class="tabs tabs-full">
        @if(session()->has('license_success'))
            <div class="alert alert-success" id="license_alert">
                <p>{{session()->get('license_success')}}</p>
            </div>
        @endif
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            ...
            <div>
                ...
                <div class="form-group {{ $errors->has('app_debug') ? ' has-error ' : '' }} mb-5">
                    <label for="app_debug">
                ...
                <div class="form-group {{ $errors->has('website_host') ? ' has-error ' : '' }}">
                    ...
                    <p class="text-red">** If you give incorrect website host, then 404 error will be shown throughout the whole website</p>
                ...
                <div class="alert alert-warning">
                    <ul class="mb-0">
                        <li>if your website URL is <code class="text-red">https://example.com/</code> , then host will be <code class="text-red">emaple.com</code></li>
                        <li>if your website URL is <code class="text-red">https://subdomain.example.com/</code> , then host will be <code class="text-red">subdomain.example.com</code></li>
                    </ul>
                </div>
