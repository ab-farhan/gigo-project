...
class CourseController extends Controller
{
  public function courses(Request $request, $domain)
  {
    ...
    $queryResult['currencyInfo'] = $this->getUserCurrencyInfo($user->id);
    ...
    return view('user-front.common.curriculum.courses', $queryResult);
  }
  ...
  public function details($domain,$slug)
  {
    ...
    $queryResult['onlineGateways'] = PaymentGateway::query()
        ->where('user_id', $user->id)
        ->where('status', 1)
        ->get();
    ...
    return view('user-front.common.curriculum.course-details', $queryResult);
  }
