...
class BlogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $information['blogs'] = DB::table('user_blogs')
            ...
            ->select('user_blogs.id', 'user_blogs.serial_number', 'user_blogs.created_at', 'user_blog_informations.title', 'user_blog_informations.author', 'user_blog_categories.name AS categoryName')
    ...
    public function store(StoreRequest $request)
    {
        ...
        foreach ($languages as $language) {
            ...
            $blogInformation->content = Purifier::clean($request[$language->code . '_content']);
    ...
    {
        $information['blog'] = Blog::query()->where('user_id', Auth::guard('web')->user()->id)->find($id);  // get all the languages from db
        $information['languages'] = Language::query()->where('user_id', Auth::guard('web')->user()->id)->get();
        $information['defaultLang'] = $information['languages']->where('is_default', 1)->first();
