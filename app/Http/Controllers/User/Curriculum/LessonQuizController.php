...
class LessonQuizController extends Controller
{
  public function create($id)
  {
    ...
    return view('user.curriculum.lesson-quiz.create', compact('lesson','defaultLang', 'courseInfo', 'default', 'module'));
  }
  ...
  public function index($id, Request $request)
  {
    ...
    $information['language'] = Language::where('code', $request->language)
                                        ...
                                        ->first();
    return view('user.curriculum.lesson-quiz.index', $information);
  }
  ...
  public function edit($lessonId, $quizId)
  {
    ...
    return view('user.curriculum.lesson-quiz.edit', $information);
  }
