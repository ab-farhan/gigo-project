<div class="main-header">
  ...
  <div class="logo-header" <?php if(request()->cookie('admin-theme') == 'dark'): ?> data-background-color="dark2" <?php endif; ?>>
    ...
    <a href="<?php echo e(route('front.index')); ?>" class="logo" target="_blank">
      <img src="<?php echo e(asset('assets/front/img/'.$bs->logo)); ?>" alt="navbar brand" class="navbar-brand" width="120">
    </a>
              ...
              <li>
                <div class="user-box">
                  ...
                  <div class="u-text">
                    ...
                    <p class="text-muted"><?php echo e(Auth::guard('admin')->user()->email); ?></p><a href="<?php echo e(route('admin.editProfile')); ?>" class="btn btn-xs btn-secondary btn-sm"><?php echo e(__('Edit Profile')); ?></a>
                  </div>
                </div>
              </li>
              <li>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(route('admin.editProfile')); ?>"><?php echo e(__('Edit Profile')); ?></a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(route('admin.changePass')); ?>"><?php echo e(__('Change Password')); ?></a>
                <div class="dropdown-divider"></div>
...
<?php /**PATH /Users/samiulalimpratik/Sites/coursemat/coursemat/resources/views/admin/partials/top-navbar.blade.php ENDPATH**/ ?>