                    ...
                    <div class="footer-widget" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="btn-groups">
                            <a href="error.html" class="btn btn-img radius-sm size-sm" title="App Store"
                                target="_blank">
                                <img class="blur-up ls-is-cached lazyloaded" src="<?php echo e(asset('/')); ?>assets/front/images/app-store.png"
                            ...
                            <a href="error.html" class="btn btn-img radius-sm size-sm" title="Play Store"
                                target="_blank">
                                <img class="blur-up ls-is-cached lazyloaded" src="<?php echo e(asset('/')); ?>assets/front/images/play-store.png"
                                    data-src="<?php echo e(asset('/')); ?>assets/front/images/play-store.png" alt="App Store">
                            </a>
                        </div>
                    </div>
                </div>
