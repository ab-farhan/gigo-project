              ...
              <div class="col-lg-8 offset-lg-2">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <br>
                            <h3 class="text-warning"><?php echo e(__('Course File & Video Upload Size')); ?></h3>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="col-lg-6">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\coursemat\resources\views/admin/basic/basicinfo.blade.php ENDPATH**/ ?>